...
public class WechartOauthService {
    ...
    public static String getAuthorizeUrl(String appid, String redirectUri, String state) {
        ...
        String getCodeUrl = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + appid + "&redirect_uri=" + redirectUri
                + "&response_type=code&scope=snsapi_base" + stateUrl + "#wechat_redirect";
